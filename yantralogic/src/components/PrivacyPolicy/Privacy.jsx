...
const Privacy = () => {
  return (
    <div className="p-32 bg-gray-900 text-white">
       
      <h1>Yantralogic Creazione Privacy Statement</h1>
      <div className="h-2 mb-7 mt-6 -ml-2 rounded-lg bg-gradient-to-r from-blue-500 to-green-500  w-full"></div>
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            "Us" or "Our" in this Agreement) refers to Yantralogic Creazione
            Pvt. Ltd., 990, Mauli Niwas, Shivaji Nagar, Kon, Thane, Maharashtra
            421311.
          </p>
        </li>
        <li>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Yantralogic Creazione, accessible
            from{" "}
            <a
              href="https://yantralogic.com/"
              rel="external nofollow noopener"
              target="_blank"
            >
              https://yantralogic.com/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: business@yantralogic.com</li>
      </ul>
    </div>
  );
};
