...
function AboutUs() {
  return (
    ...
    <div className='w-full overflow-x-hidden'>
      ...
      <div className='w-full bg-gray-600 pt-28 px-10 md:px-40'>
        <div className='grid md:grid-cols-12 md:gap-6'>
          ...
          <div className='md:col-span-6'>
            ...
            <p className='text-3xl mt-5'>The Enabler Of Platform-Led Enterprise Transformation</p>
          </div>
          {/* Right-side Section */}
          <div className='md:col-span-6 text-xl'>
      ...
      {/* Description */}
      <div className='md:mx-20 p-4 md:p-16 w-full grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-10'>
        {/* Leftside content */}
