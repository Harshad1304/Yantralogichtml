...
function Numbers() {
  return (
    <div className=' h-auto bg-slate-200 py-24  text-black'>

    <div className=' grid grid-cols-3 gap-x-5 gap-y-16 mx-32'>
...
<div className=' flex flex-col pb-4 rounded-xl px-6 bg-newblue'>
    <div className='relative'><img src="https://appinventiv.com/wp-content/themes/twentynineteen-child/new-images/industry-cta-bg.svg" className=' absolute  right-0 top-8' alt="" /></div>
    <h2 className=' text-xl text-white font-bold py-5'> Ready to innovate and drive <br /> an impact?</h2>
    <button className=' max-w-48 text-newblue bg-white hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-3 px-7 py-2.5 me-2 mb-2  focus:outline-none'> Partner with Us </button>
</div>
    </div>           
